...
class TxEval:
    ...
    def eval_disease_centric(
        ...
        self.out = disease_centric_evaluation(
            self.df,
            self.df_train,
            self.df_valid,
            self.df_test,
    ...
    def retrieve_all_disease_idxs(self):
        return np.unique(
            self.df[self.df.x_type == "disease"].x_idx.unique().tolist()
            + self.df[self.df.y_type == "disease"].y_idx.unique().tolist()
        )
