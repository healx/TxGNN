...
parser.add_argument(
    "--model", type=str, default="TxGNN", choices=["TxGNN", "GNN", "TxGAT"]
)
parser.add_argument(
    "--resume", action="store_true", help="skip runs with existing outputs"
)
parser.add_argument(
    "--gpu-sampling", action="store_true", help="use GPU graph sampling during pretrain"
)
...
TxGNN.finetune(n_epoch=500, learning_rate=5e-4, train_print_per_n=5, valid_per_n=20)
